namespace ValhallaBebidas.UI
{
    partial class ucNovoPedido
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelConteudo.Controls.Add(cmbStatus);
            panelConteudo.Controls.Add(lblAdicionarItens);
            panelConteudo.Controls.Add(cmbProduto);
            panelConteudo.Controls.Add(numQtd);
            panelConteudo.Controls.Add(btnAdicionarItem);
            panelConteudo.Controls.Add(lblCarrinho);
            panelConteudo.Controls.Add(dgvItens);
            panelConteudo.Controls.Add(btnFinalizar);
            panelConteudo.Controls.Add(btnCancelar);
            panelConteudo.CustomizableEdges = customizableEdges7;
            ...
            dgvItens.Location = new Point(25, 185);
        ...
        private Label lblAdicionarItens;
